...
class SimpleDeviceParameterComponent(Component):
    ...
    def __init__(self, device_provider=None, device_bank_registry=None, toggle_lock=None, *a, **k):
        ...
        self._device_name_slot = self.register_slot(None, self._update_device_name_display, 'name')
    ...
    def update(self):
        ...
        if self.is_enabled():
            ...
            self._SimpleDeviceParameterComponent__on_device_on_off_changed.subject = self._on_off_parameter()
            self._update_device_on_off_button()
