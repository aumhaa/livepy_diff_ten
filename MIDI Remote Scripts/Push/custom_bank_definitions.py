...
RACK_BANKS = IndexedDict(((u'Macros', {PARAMETERS_KEY: (u'Macro 1',
                    u'Macro 2',
                    u'Macro 3',
                    u'Macro 4',
                    u'Macro 5',
...
BANK_DEFINITIONS = {u'AudioEffectGroupDevice': RACK_BANKS,
 ...
 u'UltraAnalog': IndexedDict(((MAIN_KEY, {PARAMETERS_KEY: (use(u'OSC1 Shape').if_parameter(u'OSC1 On/Off').has_value(u'On').else_use(u'OSC2 Shape').if_parameter(u'OSC2 On/Off').has_value(u'On'),
                                     ...
                                     u'Volume')}),
                  (u'Osc. 1 Shape', {PARAMETERS_KEY: (u'OSC1 On/Off',
                  ...
                  (u'Osc. 1 Pitch', {PARAMETERS_KEY: (u'OSC1 On/Off',
                  ...
                  (u'Osc. 2 Shape', {PARAMETERS_KEY: (u'OSC2 On/Off',
                  ...
                  (u'Osc. 2 Pitch', {PARAMETERS_KEY: (u'OSC2 On/Off',
                  ...
                  (u'Filters', {PARAMETERS_KEY: (u'F1 On/Off',
                  ...
                  (u'Filt. 1 Env.', {PARAMETERS_KEY: (u'F1 On/Off',
                  ...
                  (u'Filt. 2 Env.', {PARAMETERS_KEY: (u'F2 On/Off',
                                     use(u'FEG2 < Vel').if_parameter(u'F1 On/Off').has_value(u'On'),
                                     use(u'FEG2 A < Vel').if_parameter(u'F1 On/Off').has_value(u'On'),
                                     use(u'FEG2 Attack').if_parameter(u'F1 On/Off').has_value(u'On'),
                                     use(u'FEG2 Decay').if_parameter(u'F1 On/Off').has_value(u'On'),
                                     use(u'FEG2 Sustain').if_parameter(u'F1 On/Off').has_value(u'On'),
                                     use(u'FEG2 S Time').if_parameter(u'F1 On/Off').has_value(u'On'),
                                     use(u'FEG2 Rel').if_parameter(u'F1 On/Off').has_value(u'On'))}),
                  (u'Filt. Modulation', {PARAMETERS_KEY: (u'F1 On/Off',
                  ...
                  (u'Amp', {PARAMETERS_KEY: (use(u'AMP1 Level').if_parameter(u'AMP1 On/Off').has_value(u'On'),
                  ...
                  (u'Amp 1 Envelope', {PARAMETERS_KEY: (u'AMP1 On/Off',
                  ...
                  (u'Amp 2 Envelope', {PARAMETERS_KEY: (u'AMP2 On/Off',
                  ...
                  (u'Noise & Unison', {PARAMETERS_KEY: (u'Noise On/Off',
                                     ...
                                     u'')}),
                  (u'Performance', {PARAMETERS_KEY: (u'Glide On/Off',
                                     ...
                                     u'Key Error',
                                     u'Voices')}),
                  (u'LFO 1', {PARAMETERS_KEY: (u'LFO1 On/Off',
                  ...
                  (u'LFO 2', {PARAMETERS_KEY: (u'LFO2 On/Off',
                  ...
                  (u'Vibrato', {PARAMETERS_KEY: (u'Vib On/Off',
                                     ...
                                     u'')}))),
 u'Collision': IndexedDict(((MAIN_KEY, {PARAMETERS_KEY: (use(u'Res 1 Type').if_parameter(u'Res 1 On/Off').has_value(u'On'),
                                   ...
                                   u'Volume')}),
                (u'Mix', {PARAMETERS_KEY: (use(u'Res 1 Volume').if_parameter(u'Res 1 On/Off').has_value(u'On'),
                                   ...
                                   u'Structure',
                                   u'Volume')}),
                (u'Mallet', {PARAMETERS_KEY: (u'Mallet On/Off',
                ...
                (u'Noise Envelope', {PARAMETERS_KEY: (u'Noise On/Off',
                ...
                (u'Noise Filter', {PARAMETERS_KEY: (u'Noise On/Off',
                                   use(u'Noise Volume').if_parameter(u'Noise On/Off').has_value(u'On'),
                ...
                (u'Res. 1 Body', {PARAMETERS_KEY: (u'Res 1 On/Off',
                ...
                (u'Res. 1 Tune', {PARAMETERS_KEY: (u'Res 1 On/Off',
                                   use(u'').if_parameter(u'Res 1 On/Off').has_value(u'Off').else_use(u'').if_parameter(u'Res 1 Type').has_value(u'Tube').else_use(u'').if_parameter(u'Res 1 Type').has_value(u'Pipe').else_use(u'Res 1 Brightness'),
                ...
                (u'Res. 2 Body', {PARAMETERS_KEY: (u'Res 2 On/Off',
                ...
                (u'Res. 2 Tune', {PARAMETERS_KEY: (u'Res 2 On/Off',
                ...
                (u'LFO 1', {PARAMETERS_KEY: (u'LFO 1 On/Off',
                ...
                (u'LFO 2', {PARAMETERS_KEY: (u'LFO 2 On/Off',
                ...
                (u'Mallet Mod.', {PARAMETERS_KEY: (u'Mallet On/Off',
                                   ...
                                   u'')}))),
 u'LoungeLizard': IndexedDict(((MAIN_KEY, {PARAMETERS_KEY: (u'M Stiffness',
                                      u'M Force',
                                      u'Noise Amount',
                                      u'F Tine Vol',
                                      u'F Tone Vol',
                                      ...
                                      u'P Symmetry',
                                      u'Volume')}),
                   (u'Mallet', {PARAMETERS_KEY: (u'M Stiffness',
                                      u'M Force',
                                      u'Noise Pitch',
                                      u'Noise Decay',
                                      u'Noise Amount',
                                      ...
                                      u'M Force < Vel',
                                      u'Volume')}),
                   (u'Fork', {PARAMETERS_KEY: (u'F Tine Color',
                                      u'F Tine Decay',
                                      u'F Tine Vol',
                                      u'F Tone Vol',
                                      u'F Tone Decay',
                                      ...
                                      u'F Tine < Key',
                                      u'Volume')}),
                   (u'Damper', {PARAMETERS_KEY: (u'Damp Tone',
                                      u'Damp Balance',
                                      u'Damp Amount',
                                      u'',
                                      u'',
                                      ...
                                      u'',
                                      u'Volume')}),
                   (u'Pickup', {PARAMETERS_KEY: (u'P Symmetry',
                                      u'P Distance',
                                      u'P Amp In',
                                      u'P Amp Out',
                                      u'Pickup Model',
                                      ...
                                      u'',
                                      u'Volume')}),
                   (u'Modulation', {PARAMETERS_KEY: (u'M Stiff < Vel',
                                      u'M Stiff < Key',
                                      u'M Force < Vel',
                                      u'M Force < Key',
                                      u'Noise < Key',
                                      ...
                                      u'P Amp < Key',
                                      u'Volume')}),
                   (u'Global', {PARAMETERS_KEY: (u'KB Stretch',
                                      u'PB Range',
                                      u'',
                                      u'',
                                      u'Voices',
                                      ...
                                      u'Detune',
                                      u'Volume')}))),
 u'InstrumentImpulse': IndexedDict(((MAIN_KEY, {PARAMETERS_KEY: (u'1 Transpose',
                                           u'1 Volume',
                                           u'3 Transpose',
                                           u'3 Volume',
                                           u'7 Transpose',
                                           ...
                                           u'8 Transpose',
                                           u'8 Volume')}),
                        (u'Pad 1', {PARAMETERS_KEY: (u'1 Start',
                                           u'1 Envelope Decay',
                                           u'1 Stretch Factor',
                                           u'1 Saturator Drive',
                                           u'1 Envelope Type',
                                           ...
                                           u'1 Volume <- Vel',
                                           u'1 Volume')}),
                        (u'1 Filt/Mod/Pan', {PARAMETERS_KEY: (u'1 Filter Freq',
                                           u'1 Filter Res',
                                           u'1 Filter Type',
                                           u'1 Filter <- Vel',
                                           u'1 Filter <- Random',
                                           ...
                                           u'1 Pan <- Vel',
                                           u'1 Pan <- Random')}),
                        (u'Pad 2', {PARAMETERS_KEY: (u'2 Start',
                                           u'2 Envelope Decay',
                                           u'2 Stretch Factor',
                                           u'2 Saturator Drive',
                                           u'2 Envelope Type',
                                           ...
                                           u'2 Volume <- Vel',
                                           u'2 Volume')}),
                        (u'2 Filt/Mod/Pan', {PARAMETERS_KEY: (u'2 Filter Freq',
                                           u'2 Filter Res',
                                           u'2 Filter Type',
                                           u'2 Filter <- Vel',
                                           u'2 Filter <- Random',
                                           ...
                                           u'2 Pan <- Vel',
                                           u'2 Pan <- Random')}),
                        (u'Pad 3', {PARAMETERS_KEY: (u'3 Start',
                                           u'3 Envelope Decay',
                                           u'3 Stretch Factor',
                                           u'3 Saturator Drive',
                                           u'3 Envelope Type',
                                           ...
                                           u'3 Volume <- Vel',
                                           u'3 Volume')}),
                        (u'3 Filt/Mod/Pan', {PARAMETERS_KEY: (u'3 Filter Freq',
                                           u'3 Filter Res',
                                           u'3 Filter Type',
                                           u'3 Filter <- Vel',
                                           u'3 Filter <- Random',
                                           ...
                                           u'3 Pan <- Vel',
                                           u'3 Pan <- Random')}),
                        (u'Pad 4', {PARAMETERS_KEY: (u'4 Start',
                                           u'4 Envelope Decay',
                                           u'4 Stretch Factor',
                                           u'4 Saturator Drive',
                                           u'4 Envelope Type',
                                           ...
                                           u'4 Volume <- Vel',
                                           u'4 Volume')}),
                        (u'4 Filt/Mod/Pan', {PARAMETERS_KEY: (u'4 Filter Freq',
                                           u'4 Filter Res',
                                           u'4 Filter Type',
                                           u'4 Filter <- Vel',
                                           u'4 Filter <- Random',
                                           ...
                                           u'4 Pan <- Vel',
                                           u'4 Pan <- Random')}),
                        (u'Pad 5', {PARAMETERS_KEY: (u'5 Start',
                                           u'5 Envelope Decay',
                                           u'5 Stretch Factor',
                                           u'5 Saturator Drive',
                                           u'5 Envelope Type',
                                           ...
                                           u'5 Volume <- Vel',
                                           u'5 Volume')}),
                        (u'5 Filt/Mod/Pan', {PARAMETERS_KEY: (u'5 Filter Freq',
                                           u'5 Filter Res',
                                           u'5 Filter Type',
                                           u'5 Filter <- Vel',
                                           u'5 Filter <- Random',
                                           ...
                                           u'5 Pan <- Vel',
                                           u'5 Pan <- Random')}),
                        (u'Pad 6', {PARAMETERS_KEY: (u'6 Start',
                                           u'6 Envelope Decay',
                                           u'6 Stretch Factor',
                                           u'6 Saturator Drive',
                                           u'6 Envelope Type',
                                           ...
                                           u'6 Volume <- Vel',
                                           u'6 Volume')}),
                        (u'6 Filt/Mod/Pan', {PARAMETERS_KEY: (u'6 Filter Freq',
                                           u'6 Filter Res',
                                           u'6 Filter Type',
                                           u'6 Filter <- Vel',
                                           u'6 Filter <- Random',
                                           ...
                                           u'6 Pan <- Vel',
                                           u'6 Pan <- Random')}),
                        (u'Pad 7', {PARAMETERS_KEY: (u'7 Start',
                                           u'7 Envelope Decay',
                                           u'7 Stretch Factor',
                                           u'7 Saturator Drive',
                                           u'7 Envelope Type',
                                           ...
                                           u'7 Volume <- Vel',
                                           u'7 Volume')}),
                        (u'7 Filt/Mod/Pan', {PARAMETERS_KEY: (u'7 Filter Freq',
                                           u'7 Filter Res',
                                           u'7 Filter Type',
                                           u'7 Filter <- Vel',
                                           u'7 Filter <- Random',
                                           ...
                                           u'7 Pan <- Vel',
                                           u'7 Pan <- Random')}),
                        (u'Pad 8', {PARAMETERS_KEY: (u'8 Start',
                                           u'8 Envelope Decay',
                                           u'8 Stretch Factor',
                                           u'8 Saturator Drive',
                                           u'8 Envelope Type',
                                           ...
                                           u'8 Volume <- Vel',
                                           u'8 Volume')}),
                        (u'8 Filt/Mod/Pan', {PARAMETERS_KEY: (u'8 Filter Freq',
                                           u'8 Filter Res',
                                           u'8 Filter Type',
                                           u'8 Filter <- Vel',
                                           u'8 Filter <- Random',
                                           ...
                                           u'8 Pan <- Vel',
                                           u'8 Pan <- Random')}),
                        (u'Global', {PARAMETERS_KEY: (u'Global Time',
                                           u'Global Transpose',
                                           u'Global Volume',
                                           u'',
                                           u'',
                                           ...
                                           u'',
                                           u'')}))),
 u'Operator': IndexedDict(((MAIN_KEY, {PARAMETERS_KEY: (use(u'Algorithm').if_parameter(u'Filter On').has_value(u'Off').else_use(u'Filter Freq'),
                                  ...
                                  u'Volume')}),
               (u'Global', {PARAMETERS_KEY: (u'Time',
                                  u'Time < Key',
                                  u'Tone',
                                  u'Algorithm',
                                  u'Panorama',
                                  ...
                                  u'Pan < Rnd',
                                  u'Volume')}),
               (u'Osc. A', {PARAMETERS_KEY: (u'Osc-A On',
               ...
               (u'Osc. A Env.', {PARAMETERS_KEY: (u'Osc-A On',
               ...
               (u'Osc. B', {PARAMETERS_KEY: (u'Osc-B On',
                                  use(u'Osc-B Level').if_parameter(u'Osc-B On').has_value(u'On'),
               ...
               (u'Osc. B Env.', {PARAMETERS_KEY: (u'Osc-B On',
               ...
               (u'Osc. C', {PARAMETERS_KEY: (u'Osc-C On',
               ...
               (u'Osc. C Env.', {PARAMETERS_KEY: (u'Osc-C On',
               ...
               (u'Osc. D', {PARAMETERS_KEY: (u'Osc-D On',
               ...
               (u'Osc. D Env.', {PARAMETERS_KEY: (u'Osc-D On',
               ...
               (u'Filter', {PARAMETERS_KEY: (u'Filter On',
               ...
               (u'Filt. Env.', {PARAMETERS_KEY: (use(u'Fe Amount').if_parameter(u'Filter On').has_value(u'On'),
               ...
               (u'LFO', {PARAMETERS_KEY: (u'LFO On',
                                  ...
                                  u'',
                                  u'')}),
               (u'LFO Env.', {PARAMETERS_KEY: (u'LFO On',
               ...
               (u'Pitch', {PARAMETERS_KEY: (u'Transpose',
                                  u'Spread',
                                  u'Glide On',
               ...
               (u'Pitch Env.', {PARAMETERS_KEY: (u'Pe On',
 ...
 u'MultiSampler': IndexedDict(((MAIN_KEY, {PARAMETERS_KEY: (u'Ve Attack',
                                      u'Ve Decay',
                                      u'Ve Sustain',
                                      u'Ve Release',
                                      ...
                                      u'Volume')}),
                   (u'Volume Env.', {PARAMETERS_KEY: (u'Ve Init',
                                      u'Ve Attack',
                                      u'Ve Peak',
                                      u'Ve Decay',
                                      u'Ve Sustain',
                                      ...
                                      u'Vol < Vel',
                                      u'Volume')}),
                   (u'Env. Loop & Pan', {PARAMETERS_KEY: (u'Ve Mode',
                                      ...
                                      u'Time',
                                      u'Time < Key')}),
                   (u'Filter', {PARAMETERS_KEY: (u'F On',
                   ...
                   (u'Filt. Env', {PARAMETERS_KEY: (u'Fe On',
                   ...
                   (u'Shaper', {PARAMETERS_KEY: (u'Fe On',
                   ...
                   (u'Osc. pg. 1', {PARAMETERS_KEY: (u'Osc On',
                   ...
                   (u'Osc. pg. 2', {PARAMETERS_KEY: (use(u'Oe End').if_parameter(u'Osc On').has_value(u'On'),
                   ...
                   (u'Pitch Env.', {PARAMETERS_KEY: (u'Pe On',
                                      ...
                                      use(u'Pe Sustain').if_parameter(u'Pe On').has_value(u'On'),
                                      use(u'Pe Release').if_parameter(u'Pe On').has_value(u'On'))}),
                   (u'Pitch Env. 2', {PARAMETERS_KEY: (u'Pe On',
                                      use(u'Pe End').if_parameter(u'Pe On').has_value(u'On'),
                                      use(u'Pe R < Vel').if_parameter(u'Pe On').has_value(u'On'),
                                      ...
                                      u'',
                                      u'')}),
                   (u'Pitch/Glide', {PARAMETERS_KEY: (u'Pe On',
                                      u'Spread',
                                      u'Transpose',
                                      u'Detune',
                                      u'Key Zone Shift',
                                      ...
                                      u'')}),
                   (u'LFO1 pg. 1', {PARAMETERS_KEY: (u'L 1 On',
                   ...
                   (u'LFO1 pg. 2', {PARAMETERS_KEY: (u'L 1 On',
                                      ...
                                      u'',
                                      u'')}),
                   (u'LFO2 pg. 1', {PARAMETERS_KEY: (u'L 2 On',
                                      ...
                                      u'')}),
                   (u'LFO2 pg. 2', {PARAMETERS_KEY: (u'L 2 On',
                                      ...
                                      u'',
                                      u'')}),
                   (u'LFO3 pg. 1', {PARAMETERS_KEY: (u'L 3 On',
                                      ...
                                      u'')}),
                   (u'LFO3 pg. 2', {PARAMETERS_KEY: (u'L 3 On',
                                      ...
                                      u'',
                                      u'')}),
                   (u'Aux Env.', {PARAMETERS_KEY: (u'Ae On',
                   ...
                   (u'Aux Env. 2', {PARAMETERS_KEY: (u'Ae On',
                                      ...
                                      u'',
                                      u'')}))),
 u'OriginalSimpler': IndexedDict(((MAIN_KEY, {PARAMETERS_KEY: (use(u'Ve Attack').if_parameter(u'Multi Sample').has_value(u'On').else_use(u'Start'),
                      ...
                      (u'Global', {PARAMETERS_KEY: (u'Glide Mode',
                                         ...
                                         u'Gain',
                                         u'Volume')}),
                      (u'Volume Envelope', {PARAMETERS_KEY: (use(u'Ve Attack').if_parameter(u'Mode').has_value(u'Classic').else_use(u'Fade In'),
                                         ...
                                         u'Vol < LFO',
                                         u'Volume')}),
                      (u'Warp', {PARAMETERS_KEY: (use(u'').if_parameter(u'Multi Sample').has_value(u'On').else_use(u'Warp'),
                      ...
                      (u'Filter Envelope', {PARAMETERS_KEY: (u'Fe On',
                                         use(u'Fe Attack').if_parameter(u'Fe On').has_value(u'On'),
                                         use(u'Fe Decay').if_parameter(u'Fe On').has_value(u'On'),
                                         use(u'Fe Sustain').if_parameter(u'Fe On').has_value(u'On'),
                                         use(u'Fe Release').if_parameter(u'Fe On').has_value(u'On'),
                                         ...
                                         use(u'Fe < Env').if_parameter(u'Fe On').has_value(u'On'))}),
                      (u'Pitch Envelope', {PARAMETERS_KEY: (u'Pe On',
                                         use(u'Pe Attack').if_parameter(u'Pe On').has_value(u'On'),
                                         use(u'Pe Decay').if_parameter(u'Pe On').has_value(u'On'),
                                         use(u'Pe Sustain').if_parameter(u'Pe On').has_value(u'On'),
                                         use(u'Pe Release').if_parameter(u'Pe On').has_value(u'On'),
                      ...
                      (u'Pan', {PARAMETERS_KEY: (u'Pan',
                                         ...
                                         u'',
                                         u'')}))),
 u'StringStudio': IndexedDict(((MAIN_KEY, {PARAMETERS_KEY: (use(u'Excitator Type').if_parameter(u'Exc On/Off').has_value(u'On'),
                                      ...
                                      u'Str Damping',
                                      u'Volume')}),
                   (u'Excitator', {PARAMETERS_KEY: (u'Exc On/Off',
                                      ...
                                      u'Volume')}),
                   (u'String & Pickup', {PARAMETERS_KEY: (u'String Decay',
                                      u'S Decay < Key',
                                      u'S Decay Ratio',
                                      u'Str Inharmon',
                                      u'Str Damping',
                   ...
                   (u'Damper', {PARAMETERS_KEY: (u'Damper On',
                   ...
                   (u'Termination', {PARAMETERS_KEY: (u'Term On/Off',
                                      ...
                                      u'',
                                      u'Volume')}),
                   (u'Body', {PARAMETERS_KEY: (u'Body On/Off',
                                      ...
                                      u'Volume')}),
                   (u'Filter', {PARAMETERS_KEY: (u'Filter On/Off',
                   ...
                   (u'LFO', {PARAMETERS_KEY: (u'LFO On/Off',
                                      ...
                                      u'',
                                      u'')}),
                   (u'Vibrato', {PARAMETERS_KEY: (u'Vibrato On/Off',
                                      ...
                                      u'')}),
                   (u'Unison & Portamento', {PARAMETERS_KEY: (u'Unison On/Off',
                   ...
                   (u'Global', {PARAMETERS_KEY: (u'Octave',
                                      u'Semitone',
                                      u'Fine Tune',
                                      u'Voices',
                                      u'PB Depth',
                                      ...
                                      u'Error',
                                      u'Key Priority')}),
                   (u'Filt. Env.', {PARAMETERS_KEY: (u'FEG On/Off',
                                      ...
                                      u'')}),
                   (u'Excitator Mod.', {PARAMETERS_KEY: (use(u'Exc Prot < Vel').if_parameter(u'Exc On/Off').has_value(u'On'),
                   ...
                   (u'Mass Mod.', {PARAMETERS_KEY: (use(u'D Mass < Key').if_parameter(u'Damper On').has_value(u'On'),
                                      ...
                                      u'',
                                      u'')}))),
 u'InstrumentVector': IndexedDict(((MAIN_KEY, {PARAMETERS_KEY: (use(u'Osc 1 Pos').with_name(u'Pos 1').if_parameter(u'Osc 1 On').has_value(u'On').else_use(u'Osc 2 Pos').with_name(u'Pos 2').if_parameter(u'Osc 2 On').has_value(u'On').else_use(u'Sub Tone').if_parameter(u'Sub On').has_value(u'On').else_use(u''),
                                          ...
                                          u'Global Mod Amount',
                                          u'Volume')}),
                       (u'Osc 1', {PARAMETERS_KEY: (u'Osc 1 On',
                                          use(u'Osc 1 Transp').with_name(u'Transp'),
                                          use(u'Osc 1 Detune').with_name(u'Detune'),
                                          use(u'Osc 1 Pos').with_name(u'Position'),
                                          use(u'Osc 1 Effect 1').with_name(u'FX 1'),
                                          use(u'Osc 1 Effect 2').with_name(u'FX 2'),
                                          use(u'Osc 1 Pan').with_name(u'Pan'),
                                          use(u'Osc 1 Gain').with_name(u'Gain'))}),
                       (u'Osc 2', {PARAMETERS_KEY: (u'Osc 2 On',
                                          use(u'Osc 2 Transp').with_name(u'Transp'),
                                          use(u'Osc 2 Detune').with_name(u'Detune'),
                                          use(u'Osc 2 Pos').with_name(u'Position'),
                                          use(u'Osc 2 Effect 1').with_name(u'FX 1'),
                                          use(u'Osc 2 Effect 2').with_name(u'FX 2'),
                                          use(u'Osc 2 Pan').with_name(u'Pan'),
                                          use(u'Osc 2 Gain').with_name(u'Gain'))}),
                       (u'Sub', {PARAMETERS_KEY: (u'Sub On',
                       ...
                       (u'Filter 1', {PARAMETERS_KEY: (use(u'Filter 1 On').with_name(u'F1 On'),
                                          ...
                                          u'')}),
                       (u'Filter 2', {PARAMETERS_KEY: (use(u'Filter 2 On').with_name(u'F2 On'),
                                          ...
                                          u'')}),
                       (u'Amp Env', {PARAMETERS_KEY: (use(u'Amp Attack').with_name(u'Attack'),
                       ...
                       (u'Env 2', {PARAMETERS_KEY: (use(u'Env 2 Attack').with_name(u'Attack'),
                       ...
                       (u'Env 3', {PARAMETERS_KEY: (use(u'Env 3 Attack').with_name(u'Attack'),
                       ...
                       (u'LFO 1', {PARAMETERS_KEY: (use(u'LFO 1 Shape').with_name(u'Shape'),
                       ...
                       (u'LFO 2', {PARAMETERS_KEY: (use(u'LFO 2 Shape').with_name(u'Shape'),
                       ...
                       (u'Global', {PARAMETERS_KEY: (u'Time',
                                          ...
                                          u'Transpose',
                                          u'Volume')}))),
 u'MidiArpeggiator': IndexedDict(((MAIN_KEY, {PARAMETERS_KEY: (u'Style',
                                         ...
                                         u'Tranpose Key',
                                         u'Transp. Steps',
                                         u'Transp. Dist.')}), (u'Rhythm', {PARAMETERS_KEY: (u'Sync On',
                                         use(u'Synced Rate').if_parameter(u'Sync On').has_value(u'On').else_use(u'Free Rate'),
                                         ...
                                         u'Gate',
                                         u'Retrigger Mode',
                                         use(u'Ret. Interval').if_parameter(u'Retrigger Mode').has_value(u'Beat'))}), (u'Pitch/Vel.', {PARAMETERS_KEY: (u'Tranpose Mode',
 ...
 u'MidiChord': IndexedDict(((u'Shift', {PARAMETERS_KEY: (u'Shift1',
                                   u'Shift2',
                                   u'Shift3',
                                   u'Shift4',
                                   u'Shift5',
                                   u'Shift6',
                                   u'',
                                   u'')}), (u'Velocity', {PARAMETERS_KEY: (u'Velocity1',
                                   u'Velocity2',
                                   u'Velocity3',
                                   u'Velocity4',
                                   u'Velocity5',
                                   ...
                                   u'',
                                   u'')}))),
 u'MidiNoteLength': IndexedDict(((MAIN_KEY, {PARAMETERS_KEY: (u'Trigger Mode',
                                        u'Sync On',
                                        ...
                                        u'')}),)),
 u'MidiPitcher': IndexedDict(((MAIN_KEY, {PARAMETERS_KEY: (u'Pitch',
                                     u'Range',
                                     u'Lowest',
                                     u'',
                                     u'',
                                     ...
                                     u'',
                                     u'')}),)),
 u'MidiRandom': IndexedDict(((MAIN_KEY, {PARAMETERS_KEY: (u'Chance',
                                    u'Choices',
                                    u'Mode',
                                    u'Scale',
                                    u'Sign',
                                    ...
                                    u'',
                                    u'')}),)),
 u'MidiScale': IndexedDict(((MAIN_KEY, {PARAMETERS_KEY: (u'Base',
                                   u'Transpose',
                                   u'Range',
                                   u'Lowest',
                                   u'Fold',
                                   ...
                                   u'',
                                   u'')}),)),
 u'MidiVelocity': IndexedDict(((MAIN_KEY, {PARAMETERS_KEY: (u'Mode',
                                      ...
                                      u'Random')}),)),
 u'Amp': IndexedDict(((u'Global', {PARAMETERS_KEY: (u'Amp Type',
                             u'Bass',
                             u'Middle',
                             u'Treble',
                             u'Presence',
                             u'Gain',
                             u'Volume',
                             u'Dry/Wet')}), (u'Dual/Mono', {PARAMETERS_KEY: (u'Dual Mono',
                             u'',
                             u'',
                             u'',
                             u'',
                             ...
                             u'',
                             u'')}))),
 u'AutoFilter': IndexedDict(((MAIN_KEY, {PARAMETERS_KEY: (use(u'Filter Type').if_parameter(u'Filter Type').is_available(True).else_use(u'Filter Type (Legacy)'),
                                    use(u'Frequency'),
                 ...
                 (u'Envelope', {PARAMETERS_KEY: (use(u'Filter Type').if_parameter(u'Filter Type').is_available(True).else_use(u'Filter Type (Legacy)'),
                                    use(u'Frequency'),
                                    use(u'Resonance').if_parameter(u'Resonance').is_available(True).else_use(u'Resonance (Legacy)'),
                                    ...
                                    u'Env. Release',
                                    u'Env. Modulation')}),
                 (u'LFO', {PARAMETERS_KEY: (u'LFO Amount',
                                    u'LFO Waveform',
                                    u'LFO Sync',
                                    use(u'LFO Frequency').if_parameter(u'LFO Sync').has_value(u'Free').else_use(u'LFO Sync Rate'),
                 ...
                 (u'Sidechain', {PARAMETERS_KEY: (u'S/C On',
                                    ...
                                    u'',
                                    u'')}))),
 u'AutoPan': IndexedDict(((MAIN_KEY, {PARAMETERS_KEY: (u'Amount',
                                 u'Shape',
                                 u'Invert',
                                 u'Waveform',
                                 u'LFO Type',
 ...
 u'BeatRepeat': IndexedDict(((MAIN_KEY, {PARAMETERS_KEY: (u'Grid',
                                    u'Interval',
                                    u'Offset',
                                    u'Gate',
                                    u'Pitch',
                                    u'Pitch Decay',
                                    u'Variation',
                                    u'Chance')}), (u'Filt/Mix', {PARAMETERS_KEY: (u'Filter On',
                                    use(u'Filter Freq').if_parameter(u'Filter On').has_value(u'On'),
                                    ...
                                    u'Volume',
                                    u'Decay',
                                    u'Chance')}), (u'Repeat Rate', {PARAMETERS_KEY: (u'Repeat',
                                    u'Interval',
                                    u'Offset',
                                    u'Gate',
                                    u'Grid',
                                    ...
                                    u'Variation',
                                    u'Variation Type')}))),
 u'Cabinet': IndexedDict(((MAIN_KEY, {PARAMETERS_KEY: (u'Cabinet Type',
                                 u'Microphone Type',
                                 ...
                                 u'',
                                 u'Dry/Wet')}),)),
 u'Chorus': IndexedDict(((u'Chorus', {PARAMETERS_KEY: (u'LFO Amount',
                                u'LFO Rate',
                                u'Delay 1 Time',
                                u'Delay 1 HiPass',
                                u'Delay 2 Mode',
                                ...
                                u'Feedback',
                                u'Dry/Wet')}), (u'Other', {PARAMETERS_KEY: (u'LFO Extend On',
                                u'Polarity',
                                u'Link On',
                                u'',
                                u'',
                                ...
                                u'',
                                u'')}))),
 u'Compressor2': IndexedDict(((MAIN_KEY, {PARAMETERS_KEY: (u'Threshold',
                                     ...
                                     u'Dry/Wet',
                                     u'Output Gain')}), (u'Sidechain', {PARAMETERS_KEY: (u'S/C On',
                                     use(u'S/C Gain').if_parameter(u'S/C On').has_value(u'On'),
                                     use(u'S/C Mix').if_parameter(u'S/C On').has_value(u'On'),
                                     u'S/C Listen',
                                     u'S/C EQ On',
                                     ...
                                     u'Dry/Wet',
                                     u'Output Gain')}))),
 u'Corpus': IndexedDict(((MAIN_KEY, {PARAMETERS_KEY: (u'Resonance Type',
                                ...
                                u'Dry Wet')}),
             (u'Body', {PARAMETERS_KEY: (u'Resonance Type',
             ...
             (u'LFO', {PARAMETERS_KEY: (u'LFO On/Off',
                                ...
                                u'')}),
             (u'Tune & Sidechain', {PARAMETERS_KEY: (u'MIDI Frequency',
                                u'MIDI Mode',
                                use(u'Transpose').if_parameter(u'MIDI Frequency').has_value(u'On').else_use(u'Tune'),
             ...
             (u'Filter & Mix', {PARAMETERS_KEY: (u'Filter On/Off',
                                ...
                                u'Dry Wet',
                                u'')}))),
 u'Tube': IndexedDict(((u'Character', {PARAMETERS_KEY: (u'Drive',
                              u'Tube Type',
                              u'Bias',
                              u'Tone',
                              u'Attack',
                              u'Release',
                              u'Envelope',
                              u'Dry/Wet')}), (u'Output', {PARAMETERS_KEY: (u'',
                              u'',
                              u'',
                              u'',
                              u'',
 ...
 u'Echo': IndexedDict(((MAIN_KEY, {PARAMETERS_KEY: (use(u'L Time').with_name(u'M Time').if_parameter(u'Channel Mode').has_value(u'Mid/Side').and_parameter(u'L Sync').has_value(u'Off').else_use(u'L Time').if_parameter(u'L Sync').has_value(u'Off').else_use(u'L 16th').with_name(u'M 16th').if_parameter(u'Channel Mode').has_value(u'Mid/Side').and_parameter(u'L Sync Mode').has_value(u'16th').else_use(u'L 16th').if_parameter(u'L Sync Mode').has_value(u'16th').else_use(u'L Division').with_name(u'M Division').if_parameter(u'Channel Mode').has_value(u'Mid/Side').else_use(u'L Division'),
                              ...
                              u'Input Gain',
                              u'Dry Wet')}),
           (u'L/Mid', {PARAMETERS_KEY: (use(u'L Time').with_name(u'M Time').if_parameter(u'Channel Mode').has_value(u'Mid/Side').and_parameter(u'L Sync').has_value(u'Off').else_use(u'L Time').if_parameter(u'L Sync').has_value(u'Off').else_use(u'L 16th').with_name(u'M 16th').if_parameter(u'Channel Mode').has_value(u'Mid/Side').and_parameter(u'L Sync Mode').has_value(u'16th').else_use(u'L 16th').if_parameter(u'L Sync Mode').has_value(u'16th').else_use(u'L Division').with_name(u'M Division').if_parameter(u'Channel Mode').has_value(u'Mid/Side').else_use(u'L Division'),
                              use(u'L Sync').with_name(u'M Sync').if_parameter(u'Channel Mode').has_value(u'Mid/Side').else_use(u'L Sync'),
                              use(u'L Sync Mode').with_name(u'M Sync Mode').if_parameter(u'Channel Mode').has_value(u'Mid/Side').and_parameter(u'L Sync').has_value(u'On').else_use(u'L Sync Mode').if_parameter(u'L Sync').has_value(u'On'),
           ...
           (u'R/Side', {PARAMETERS_KEY: (use(u'R Time').with_name(u'S Time').if_parameter(u'Channel Mode').has_value(u'Mid/Side').and_parameter(u'R Sync').has_value(u'Off').and_parameter(u'Link').has_value(u'Off').else_use(u'R Time').if_parameter(u'R Sync').has_value(u'Off').and_parameter(u'Link').has_value(u'Off').else_use(u'R 16th').with_name(u'S 16th').if_parameter(u'Channel Mode').has_value(u'Mid/Side').and_parameter(u'R Sync Mode').has_value(u'16th').and_parameter(u'Link').has_value(u'Off').else_use(u'R 16th').if_parameter(u'R Sync Mode').has_value(u'16th').and_parameter(u'Link').has_value(u'Off').else_use(u'R Division').with_name(u'S Division').if_parameter(u'Channel Mode').has_value(u'Mid/Side').and_parameter(u'Link').has_value(u'Off').else_use(u'R Division').if_parameter(u'Link').has_value(u'Off').else_use(u'L Time').with_name(u'M Time').if_parameter(u'Channel Mode').has_value(u'Mid/Side').and_parameter(u'L Sync').has_value(u'Off').else_use(u'L Time').if_parameter(u'L Sync').has_value(u'Off').else_use(u'L 16th').with_name(u'M 16th').if_parameter(u'Channel Mode').has_value(u'Mid/Side').and_parameter(u'L Sync Mode').has_value(u'16th').else_use(u'L 16th').if_parameter(u'L Sync Mode').has_value(u'16th').else_use(u'L Division').with_name(u'M Division').if_parameter(u'Channel Mode').has_value(u'Mid/Side').else_use(u'L Division'),
                              ...
                              u'Feedback Inv',
                              u'Dry Wet')}),
           (u'Global', {PARAMETERS_KEY: (u'Repitch',
                              u'Channel Mode',
                              u'Stereo Width',
                              u'',
                              u'Clip Dry',
           ...
           (u'Filter', {PARAMETERS_KEY: (u'Filter On',
                              ...
                              u'Output Gain',
                              u'Dry Wet')}),
           (u'Modulation', {PARAMETERS_KEY: (u'Mod Wave',
                              u'Mod Sync',
                              ...
                              u'Flt < Mod',
                              u'Mod 4x')}),
           (u'Reverb', {PARAMETERS_KEY: (u'Reverb Level',
                              u'Reverb Loc',
                              u'Reverb Decay',
                              u'',
                              u'',
                              ...
                              u'',
                              u'')}),
           (u'Gate/Ducking', {PARAMETERS_KEY: (u'Gate On',
                              u'Gate Thr',
                              u'Gate Release',
                              u'',
                              u'Duck On',
                              ...
                              u'Duck Release',
                              u'')}),
           (u'Noise/Wobble', {PARAMETERS_KEY: (u'Noise On',
                              u'Noise Amt',
                              u'Noise Mrph',
                              u'',
                              u'Wobble On',
                              ...
                              u'Wobble Mrph',
                              u'')}))),
 u'Eq8': IndexedDict(((MAIN_KEY, {PARAMETERS_KEY: (use(u'1 Frequency A').if_parameter(u'1 Filter On A').has_value(u'On'),
          ...
          (u'EQ Band 1', {PARAMETERS_KEY: (u'1 Filter On A',
                             ...
                             u'Scale',
                             u'Output Gain')}),
          (u'EQ Band 2', {PARAMETERS_KEY: (u'2 Filter On A',
                             ...
                             u'Scale',
                             u'Output Gain')}),
          (u'EQ Band 3', {PARAMETERS_KEY: (u'3 Filter On A',
                             ...
                             u'Scale',
                             u'Output Gain')}),
          (u'EQ Band 4', {PARAMETERS_KEY: (u'4 Filter On A',
                             ...
                             u'Scale',
                             u'Output Gain')}),
          (u'EQ Band 5', {PARAMETERS_KEY: (u'5 Filter On A',
                             ...
                             u'Scale',
                             u'Output Gain')}),
          (u'EQ Band 6', {PARAMETERS_KEY: (u'6 Filter On A',
                             ...
                             u'Scale',
                             u'Output Gain')}),
          (u'EQ Band 7', {PARAMETERS_KEY: (u'7 Filter On A',
                             ...
                             u'Scale',
                             u'Output Gain')}),
          (u'EQ Band 8', {PARAMETERS_KEY: (u'8 Filter On A',
                             ...
                             u'Scale',
                             u'Output Gain')}),
          (u'8 x Frequency', {PARAMETERS_KEY: (use(u'1 Frequency A').if_parameter(u'1 Filter On A').has_value(u'On'),
                             use(u'2 Frequency A').if_parameter(u'2 Filter On A').has_value(u'On'),
                             use(u'3 Frequency A').if_parameter(u'3 Filter On A').has_value(u'On'),
                             use(u'4 Frequency A').if_parameter(u'4 Filter On A').has_value(u'On'),
                             use(u'5 Frequency A').if_parameter(u'5 Filter On A').has_value(u'On'),
                             ...
                             use(u'7 Frequency A').if_parameter(u'7 Filter On A').has_value(u'On'),
                             use(u'8 Frequency A').if_parameter(u'8 Filter On A').has_value(u'On'))}),
          (u'8 x Gain', {PARAMETERS_KEY: (use(u'').if_parameter(u'1 Filter On A').has_value(u'Off').else_use(u'1 Gain A').if_parameter(u'1 Filter Type A').has_value(u'Low Shelf').else_use(u'1 Gain A').if_parameter(u'1 Filter Type A').has_value(u'Bell').else_use(u'1 Gain A').if_parameter(u'1 Filter Type A').has_value(u'High Shelf').else_use(u''),
          ...
          (u'8 x Resonance', {PARAMETERS_KEY: (u'1 Resonance A',
                             u'2 Resonance A',
                             u'3 Resonance A',
                             u'4 Resonance A',
                             u'5 Resonance A',
                             ...
                             u'7 Resonance A',
                             u'8 Resonance A')}))),
 u'FilterEQ3': IndexedDict(((u'EQ', {PARAMETERS_KEY: (u'LowOn',
                                   u'MidOn',
                                   u'HighOn',
                                   ...
                                   u'FreqLo',
                                   u'FreqHi')}), (u'Slope', {PARAMETERS_KEY: (u'Slope',
                                   u'',
                                   u'',
                                   u'',
                                   u'',
                                   ...
                                   u'',
                                   u'')}))),
 u'Erosion': IndexedDict(((MAIN_KEY, {PARAMETERS_KEY: (u'Mode',
                                 u'Frequency',
                                 ...
                                 u'',
                                 u'')}),)),
 u'ProxyAudioEffectDevice': IndexedDict(((MAIN_KEY, {PARAMETERS_KEY: (u'Input Gain',
                                                u'Output Gain',
                                                u'Dry/Wet',
                                                u'',
                                                u'',
                                                ...
                                                u'',
                                                u'')}),)),
 u'FilterDelay': IndexedDict(((MAIN_KEY, {PARAMETERS_KEY: (use(u'2 Filter Freq').if_parameter(u'2 Input On').has_value(u'On'),
                  ...
                  (u'L Filter', {PARAMETERS_KEY: (u'1 Input On',
                  ...
                  (u'L+R Filter', {PARAMETERS_KEY: (u'2 Input On',
                                     ...
                                     use(u'2 Volume').if_parameter(u'2 Input On').has_value(u'On'))}),
                  (u'R Filter', {PARAMETERS_KEY: (u'3 Input On',
                  ...
                  (u'Mix', {PARAMETERS_KEY: (use(u'1 Pan').if_parameter(u'1 Input On').has_value(u'On'),
                                     ...
                                     use(u'3 Volume').if_parameter(u'3 Input On').has_value(u'On'),
                                     u'Dry')}))),
 u'Flanger': IndexedDict(((MAIN_KEY, {PARAMETERS_KEY: (u'LFO Amount',
                                 u'Sync',
                                 ...
                                 u'Env. Modulation',
                                 u'Feedback',
                                 u'Dry/Wet')}), (u'Envelope', {PARAMETERS_KEY: (u'Env. Attack',
                                 u'Env. Release',
                                 u'Env. Modulation',
                                 u'Hi Pass',
                                 u'Delay Time',
                                 u'Feedback',
                                 u'Polarity',
                                 u'Dry/Wet')}), (u'LFO / S&H', {PARAMETERS_KEY: (u'LFO Amount',
                                 u'LFO Waveform',
                                 u'Sync',
                                 use(u'Frequency').if_parameter(u'Sync').has_value(u'Free').else_use(u'Sync Rate'),
                                 ...
                                 u'',
                                 u'')}))),
 u'FrequencyShifter': IndexedDict(((u'FreqDrive', {PARAMETERS_KEY: (u'Mode',
                                          ...
                                          u'',
                                          u'')}))),
 u'Gate': IndexedDict(((u'Gate', {PARAMETERS_KEY: (u'Threshold',
                              u'Return',
                              u'FlipMode',
                              u'LookAhead',
                              u'Attack',
                              u'Hold',
                              u'Release',
                              u'Floor')}), (u'Sidechain', {PARAMETERS_KEY: (u'S/C On',
                              use(u'S/C Gain').if_parameter(u'S/C On').has_value(u'On'),
                              use(u'S/C Mix').if_parameter(u'S/C On').has_value(u'On'),
                              u'S/C Listen',
                              u'S/C EQ On',
 ...
 u'GlueCompressor': IndexedDict(((u'Compression', {PARAMETERS_KEY: (u'Threshold',
                                        u'Ratio',
                                        u'Attack',
                                        u'Release',
                                        u'Peak Clip In',
                                        u'Range',
                                        u'Makeup',
                                        u'Dry/Wet')}), (u'Sidechain', {PARAMETERS_KEY: (u'S/C On',
                                        use(u'S/C Gain').if_parameter(u'S/C On').has_value(u'On'),
                                        use(u'S/C Mix').if_parameter(u'S/C On').has_value(u'On'),
                                        u'',
                                        u'S/C EQ On',
                                        ...
                                        use(u'S/C EQ Freq').if_parameter(u'S/C EQ On').has_value(u'On'),
                                        use(u'').if_parameter(u'S/C EQ On').has_value(u'Off').else_use(u'S/C EQ Gain').if_parameter(u'S/C EQ Type').has_value(u'Low Shelf').else_use(u'S/C EQ Gain').if_parameter(u'S/C EQ Type').has_value(u'High Shelf').else_use(u'S/C EQ Gain').if_parameter(u'S/C EQ Type').has_value(u'Bell').else_use(u'S/C EQ Q'))}))),
 u'GrainDelay': IndexedDict(((u'Pitch', {PARAMETERS_KEY: (u'Frequency',
                                    u'Pitch',
                                    u'Delay Mode',
                                    ...
                                    u'Spray',
                                    u'Feedback',
                                    u'DryWet')}), (u'Time', {PARAMETERS_KEY: (u'Delay Mode',
                                    use(u'Time Delay').if_parameter(u'Delay Mode').has_value(u'Off').else_use(u'Beat Delay'),
                                    u'Beat Swing',
                                    u'Feedback',
                                    u'',
                                    ...
                                    u'',
                                    u'DryWet')}))),
 u'Limiter': IndexedDict(((MAIN_KEY, {PARAMETERS_KEY: (u'Gain',
                                 u'Ceiling',
                                 u'Link Channels',
                                 u'Lookahead',
                                 u'Auto',
                                 ...
                                 u'',
                                 u'')}),)),
 u'Looper': IndexedDict(((MAIN_KEY, {PARAMETERS_KEY: (u'State',
                                u'Speed',
                                u'Reverse',
                                u'Quantization',
                                u'Monitor',
                                ...
                                u'Tempo Control',
                                u'Feedback')}),)),
 u'MultibandDynamics': IndexedDict(((MAIN_KEY, {PARAMETERS_KEY: (use(u'Above Threshold (Low)').if_parameter(u'Band Activator (Low)').has_value(u'On'),
                                           ...
                                           u'Master Output',
                                           u'Amount')}),
                        (u'Low Band', {PARAMETERS_KEY: (u'Band Activator (Low)',
                        ...
                        (u'Mid Band', {PARAMETERS_KEY: (u'Band Activator (Mid)',
                        ...
                        (u'High Band', {PARAMETERS_KEY: (u'Band Activator (High)',
                        ...
                        (u'Mix & Split', {PARAMETERS_KEY: (use(u'Output Gain (Low)').if_parameter(u'Band Activator (Low)').has_value(u'On'),
                                           u'Low-Mid Crossover',
                        ...
                        (u'Sidechain', {PARAMETERS_KEY: (u'S/C On',
                                           ...
                                           u'',
                                           u'')}))),
 u'Overdrive': IndexedDict(((MAIN_KEY, {PARAMETERS_KEY: (u'Filter Freq',
                                   u'Filter Width',
                                   u'Drive',
                                   u'Tone',
                                   u'Preserve Dynamics',
                                   ...
                                   u'',
                                   u'Dry/Wet')}),)),
 u'Pedal': IndexedDict(((u'Global', {PARAMETERS_KEY: (u'Type',
                               u'Gain',
                               u'Output',
                               u'Bass',
                               u'Mid',
                               u'Treble',
                               u'Sub',
                               u'Dry/Wet')}), (u'EQ', {PARAMETERS_KEY: (u'',
                               u'',
                               u'',
                               u'Bass',
                               u'Mid',
                               ...
                               u'',
                               u'Mid Freq')}))),
 u'Phaser': IndexedDict(((MAIN_KEY, {PARAMETERS_KEY: (u'Poles',
                                u'Frequency',
                                u'Feedback',
                                u'Env. Modulation',
                                u'LFO Amount',
                                u'LFO Sync',
                                use(u'LFO Frequency').if_parameter(u'LFO Sync').has_value(u'Free').else_use(u'LFO Sync Rate'),
                                u'Dry/Wet')}), (u'Envelope', {PARAMETERS_KEY: (u'Poles',
                                u'Type',
                                ...
                                u'Env. Modulation',
                                u'Env. Attack',
                                u'Env. Release')}), (u'LFO', {PARAMETERS_KEY: (u'LFO Amount',
                                u'LFO Waveform',
                                u'LFO Sync',
                                use(u'LFO Frequency').if_parameter(u'LFO Sync').has_value(u'Free').else_use(u'LFO Sync Rate'),
                                ...
                                u'',
                                u'')}))),
 u'PingPongDelay': IndexedDict(((MAIN_KEY, {PARAMETERS_KEY: (u'Delay Mode',
                                       use(u'Beat Delay').if_parameter(u'Delay Mode').has_value(u'Sync').else_use(u'Time Delay'),
                                       use(u'Beat Swing').if_parameter(u'Delay Mode').has_value(u'Sync').else_use(u''),
                                       u'Freeze',
                                       u'Filter Freq',
                                       u'Filter Width',
                                       u'Feedback',
                                       u'Dry/Wet')}),)),
 u'Redux': IndexedDict(((MAIN_KEY, {PARAMETERS_KEY: (u'Bit On',
                               ...
                               u'',
                               u'')}),)),
 u'Resonator': IndexedDict(((MAIN_KEY, {PARAMETERS_KEY: (use(u'Frequency').if_parameter(u'Filter On').has_value(u'On'),
                                   u'Decay',
                                   u'Color',
                                   ...
                                   u'Width',
                                   u'Dry/Wet')}),
                (u'Global', {PARAMETERS_KEY: (u'Mode',
                                   u'Decay',
                                   u'Const',
                                   u'Color',
                                   u'',
                ...
                (u'Filter', {PARAMETERS_KEY: (u'Filter On',
                                   ...
                                   u'',
                                   u'')}),
                (u'Mode I & II', {PARAMETERS_KEY: (u'I On',
                                   ...
                                   use(u'II Gain').if_parameter(u'II On').has_value(u'On'))}),
                (u'Mode III & IV', {PARAMETERS_KEY: (u'III On',
                ...
                (u'Mode V', {PARAMETERS_KEY: (u'V On',
                                   ...
                                   u'',
                                   u'')}),
                (u'Mix', {PARAMETERS_KEY: (use(u'I Gain').if_parameter(u'I On').has_value(u'On'),
                                   use(u'II Gain').if_parameter(u'II On').has_value(u'On'),
                                   use(u'III Gain').if_parameter(u'III On').has_value(u'On'),
                                   use(u'IV Gain').if_parameter(u'IV On').has_value(u'On'),
                                   use(u'V Gain').if_parameter(u'V On').has_value(u'On'),
                                   ...
                                   u'',
                                   u'')}),
                (u'Pitch', {PARAMETERS_KEY: (use(u'I Note').if_parameter(u'I On').has_value(u'On'),
                                   use(u'II Pitch').if_parameter(u'II On').has_value(u'On'),
                                   use(u'III Pitch').if_parameter(u'III On').has_value(u'On'),
                                   use(u'IV Pitch').if_parameter(u'IV On').has_value(u'On'),
                                   use(u'V Pitch').if_parameter(u'V On').has_value(u'On'),
                                   ...
                                   u'',
                                   u'')}))),
 u'Reverb': IndexedDict(((MAIN_KEY, {PARAMETERS_KEY: (u'PreDelay',
                                ...
                                u'Dry/Wet')}),
             (u'Global', {PARAMETERS_KEY: (u'Chorus On',
                                ...
                                u'ER Level',
                                u'Diffuse Level')}),
             (u'Diffusion Network', {PARAMETERS_KEY: (u'HiShelf On',
                                ...
                                u'Density',
                                u'Scale')}),
             (u'Input/Reflections', {PARAMETERS_KEY: (u'In LowCut On',
                                u'In HighCut On',
                                ...
                                u'ER Shape')}))),
 u'Saturator': IndexedDict(((MAIN_KEY, {PARAMETERS_KEY: (u'Drive',
                                   u'Type',
                                   u'Color',
                                   ...
                                   u'Output')}), (u'Waveshaper', {PARAMETERS_KEY: (u'Type',
                                   ...
                                   u'Output',
                                   u'Dry/Wet')}))),
 u'CrossDelay': IndexedDict(((MAIN_KEY, {PARAMETERS_KEY: (u'L Delay Mode',
                                    use(u'L Beat Delay').if_parameter(u'L Delay Mode').has_value(u'On').else_use(u'L Time Delay'),
                                    use(u'L Beat Swing').if_parameter(u'L Delay Mode').has_value(u'On'),
                                    use(u'R Delay Mode').if_parameter(u'Link On').has_value(u'Off'),
                                    use(u'').if_parameter(u'Link On').has_value(u'On').else_use(u'R Beat Delay').if_parameter(u'R Delay Mode').has_value(u'On').else_use(u'R Time Delay'),
                                    use(u'').if_parameter(u'Link On').has_value(u'On').else_use(u'R Beat Swing').if_parameter(u'R Delay Mode').has_value(u'On').else_use(u''),
                                    u'Feedback',
                                    u'Dry/Wet')}), (u'Global', {PARAMETERS_KEY: (u'',
                                    u'',
                                    u'',
                                    u'',
                                    u'',
                                    ...
                                    u'Feedback',
                                    u'Dry/Wet')}))),
 u'StereoGain': IndexedDict(((u'Utility', {PARAMETERS_KEY: (use(u'').if_parameter(u'Channel Mode').has_value(u'Right').else_use(u'Left Inv').if_parameter(u'Mute').has_value(u'Off'),
                                    ...
                                    u'Mute')}), (u'Low Freq', {PARAMETERS_KEY: (use(u'').if_parameter(u'Mute').has_value(u'On').else_use(u'').if_parameter(u'Channel Mode').has_value(u'Left').else_use(u'').if_parameter(u'Channel Mode').has_value(u'Right').else_use(u'').if_parameter(u'Mono').is_available(True).and_parameter(u'Mono').has_value(u'On').else_use(u'Bass Mono').if_parameter(u'Bass Mono').is_available(True),
                                    ...
                                    u'',
                                    u'')}))),
 u'Vinyl': IndexedDict(((u'Global', {PARAMETERS_KEY: (u'Tracing On',
                               ...
                               u'Global Drive',
                               u'Crackle Density',
                               u'Crackle Volume')}), (u'Pinch', {PARAMETERS_KEY: (u'Pinch On',
                               ...
                               u'Crackle Density',
                               u'Crackle Volume')}))),
 u'Vocoder': IndexedDict(((MAIN_KEY, {PARAMETERS_KEY: (u'Formant Shift',
                                 u'Attack Time',
                                 u'Release Time',
                                 u'Unvoiced Level',
                                 u'Gate Threshold',
                                 ...
                                 u'Envelope Depth',
                                 u'Dry/Wet')}),
              (u'Carrier', {PARAMETERS_KEY: (u'Noise Rate',
                                 u'Noise Crackle',
                                 ...
                                 u'',
                                 u'')}),
              (u'Global', {PARAMETERS_KEY: (u'Formant Shift',
                                 u'Attack Time',
                                 u'Release Time',
                                 u'Mono/Stereo',
                                 u'Output Level',
                                 ...
                                 u'Envelope Depth',
                                 u'Dry/Wet')}),
              (u'Filters/Voicing', {PARAMETERS_KEY: (u'Filter Bandwidth',
                                 u'Upper Filter Band',
                                 u'Lower Filter Band',
                                 u'Precise/Retro',
                                 u'Unvoiced Level',
