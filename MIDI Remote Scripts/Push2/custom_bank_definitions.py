 ...
 'Reverb':IndexedDict((
  (
   ...
   {BANK_PARAMETERS_KEY: (
                          ...
                          'Stereo Image',
                          'Room Size',
                          use('DecayTime').with_name('Decay'),
                          use('HiFilter Freq').with_name('Hi Filter Freq'),
                          'Dry/Wet')}),
  (
   'Input/Reflect',
   {BANK_PARAMETERS_KEY: ('ER Shape', 'In Filter Freq', 'In Filter Width', 'Size Smoothing', 'Room Size', 'ER Spin Rate',
 'ER Spin Amount', 'ER Level'), 
  ...
  (
   ...
   {BANK_PARAMETERS_KEY: (
                          ...
                          'Chorus Amount',
                          'Stereo Image',
                          use('ER Level').with_name('Reflect'),
                          use('Diffuse Level').with_name('Diffuse'),
                          'Dry/Wet'), 
