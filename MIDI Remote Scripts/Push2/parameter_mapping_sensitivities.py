...
PARAMETER_SENSITIVITIES = {u'Analog': {u'OSC1 Octave': {DEFAULT_SENSITIVITY_KEY: 0.1},
             u'OSC2 Octave': {DEFAULT_SENSITIVITY_KEY: 0.1},
             u'OSC1 Semi': {DEFAULT_SENSITIVITY_KEY: 0.5},
             u'OSC1 Detune': {DEFAULT_SENSITIVITY_KEY: 0.5},
             u'OSC2 Semi': {DEFAULT_SENSITIVITY_KEY: 0.5},
 ...
 u'Impulse': {u'1 Transpose': {DEFAULT_SENSITIVITY_KEY: 0.5},
