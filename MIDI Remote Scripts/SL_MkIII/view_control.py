...
class NotifyingViewControlComponent(ViewControlComponent):
    ...
    def __init__(self, track_provider = None, *a, **k):
        ...
        self._page_tracks.scroll_up_button.color = u'TrackNavigation.On'
        self._page_tracks.scroll_down_button.color = u'TrackNavigation.On'
        self._scroll_tracks.scroll_up_button.color = u'TrackNavigation.On'
        self._scroll_tracks.scroll_down_button.color = u'TrackNavigation.On'
        self._scroll_scenes.scroll_up_button.color = u'SceneNavigation.On'
        self._scroll_scenes.scroll_down_button.color = u'SceneNavigation.On'
