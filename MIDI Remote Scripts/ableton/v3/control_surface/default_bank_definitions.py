...
BANK_DEFINITIONS['Reverb'] = IndexedDict((
 (
  BANK_MAIN_KEY,
  {BANK_PARAMETERS_KEY: ('PreDelay', 'In Filter Freq', 'Chorus Amount', 'Stereo Image', 'Room Size', 'DecayTime',
 'Diffuse Level', 'Dry/Wet')}),
 (
  'Global',
  {BANK_PARAMETERS_KEY: ('Chorus On', 'Chorus Rate', 'Chorus Amount', 'Density', 'Freeze On', 'Flat On', 'ER Level',
 'Diffuse Level')}),
 (
  'Diffusion Network',
