...
class LaunchkeyElements(object):
    ...
    def __init__(self, *a, **k):
        ...
        drum_pad_rows = ((48, 49, 50, 51),
         ...
         (40, 41, 42, 43),
         (36, 37, 38, 39))
        self.drum_pads = ButtonMatrixElement(rows=[ [ create_button(row_identifiers[col_index], u'Drum_Pad_{}_{}'.format(col_index, row_index), msg_type=MIDI_NOTE_TYPE, channel=DRUM_CHANNEL) for col_index in xrange(4) ] for row_index, row_identifiers in enumerate(drum_pad_rows) ], name=u'Drum_Pads')
